  ...
  const ProjectBlocks = useMemo(() => {
    const projects = [
...

      {
        ...
        details:
          "Web application designed to illustrate various sorting and high runtime algorithms with variable speeds, highlighting runtime complexity and the various methods of completing given tasks.",
